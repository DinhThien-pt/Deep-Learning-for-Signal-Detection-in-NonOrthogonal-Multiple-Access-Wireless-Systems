...
% Plot SER for User 1: DL vs SIC with LS
figure();
...
semilogy(EsN0_dB, numErr_DL(1,:,1,2), 'r--o', 'LineWidth', 1.5, 'DisplayName', 'DL, CP=12'); hold on;
...
semilogy(EsN0_dB, numErr_ML(1,:,1,2), 'g--o', 'LineWidth', 1.5, 'DisplayName', 'ML with perfect CSI, CP=12'); hold off;
title('SER for User 1');
xlabel('SNR (dB)');
ylabel('Symbol Error Rate (SER)');
legend('show', 'Location', 'southwest');
grid on;
xlim([0 26]); % Limit x-axis to exactly 26 dB to match data
xticks(0:2:26); % Thêm nhãn rõ ràng đến 28
saveas(gcf, 'SER_User1_CP20_vs_CP12.png');

% Plot SER for User 1: DL vs ML
figure();
semilogy(EsN0_dB, numErr_DL(2,:,1,1), 'r-o', 'LineWidth', 1.5, 'DisplayName', 'DL, CP=20'); hold on
semilogy(EsN0_dB, numErr_SIC_LS(2,:,1,1), 'b-o', 'LineWidth', 1.5, 'DisplayName', 'SIC with LS, CP=20'); hold on;
semilogy(EsN0_dB, numErr_SIC_MMSE(2,:,1,1), 'k-o', 'LineWidth', 1.5, 'DisplayName', 'SIC with MMSE, CP=20'); hold on;
semilogy(EsN0_dB, numErr_ML(2,:,1,1), 'g-o', 'LineWidth', 1.5, 'DisplayName', 'ML with perfect CSI, CP=20'); hold on;
semilogy(EsN0_dB, numErr_DL(2,:,1,2), 'r--o', 'LineWidth', 1.5, 'DisplayName', 'DL, CP=12'); hold on;
semilogy(EsN0_dB, numErr_SIC_LS(2,:,1,2), 'b--o', 'LineWidth', 1.5, 'DisplayName', 'SIC with LS, CP=12'); hold on;
semilogy(EsN0_dB, numErr_SIC_MMSE(2,:,1,2), 'k--o', 'LineWidth', 1.5, 'DisplayName', 'SIC with MMSE, CP=12'); hold on;
semilogy(EsN0_dB, numErr_ML(2,:,1,2), 'g--o', 'LineWidth', 1.5, 'DisplayName', 'ML with perfect CSI, CP=12'); hold off;
title('SER for User 2');
xlabel('SNR (dB)');
ylabel('Symbol Error Rate (SER)');
legend('show', 'Location', 'southwest');
grid on;
xlim([0 26]); % Limit x-axis to exactly 26 dB to match data
xticks(0:2:26); % Thêm nhãn rõ ràng đến 28
saveas(gcf, 'SER_User2_CP20_vs_CP12.png');
