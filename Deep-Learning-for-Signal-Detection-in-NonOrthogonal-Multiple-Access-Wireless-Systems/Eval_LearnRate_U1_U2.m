...
% For 16 pilots with different learning rates
...
% Plot SER curves for User 1 and User 2 with different learning rates (Fig. 7)
figure();
...
title('SER curves of DNN trained with different learning rates for User 1 and User 2');
xlabel('SNR (dB)');
ylabel('Symbol Error Rate (SER)');
legend('show', 'Location', 'southwest');
xlim([0 28]); % Limit x-axis to exactly 26 dB to match data
xticks(0:2:28); % Thêm nhãn rõ ràng đến 28
grid on;

% Save the plot
saveas(gcf, 'SER_vs_SNR_DNN_LearningRates.png');
