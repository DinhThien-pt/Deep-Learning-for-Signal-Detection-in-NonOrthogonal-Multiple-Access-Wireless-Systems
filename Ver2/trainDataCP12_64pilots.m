...
numPSC_64pilots = 64; % number of pilot subcarriers (as in Fig. 5)
numUE = 2;
...
pilotSpacing = numSC/numPSC_64pilots;
...
fixedPilot_64pilots = zeros(numPSym,numPSC_64pilots,numUE);
fixedPilot_64pilots(1,:,1) = complex(sign(rand(1,numPSC_64pilots,1)-0.5)); 
fixedPilot_64pilots(2,:,2) = complex(sign(rand(1,numPSC_64pilots,1)-0.5));
fixedPilotPacket = repmat(fixedPilot_64pilots,1,1,1,numPacketClass); % use the same pilot for all packets
...
save('trainDataCP12_64pilots.mat','XTrain','YTrain','h','numPSC_64pilots','lengthCP','idx_sc','fixedPilot_64pilots');