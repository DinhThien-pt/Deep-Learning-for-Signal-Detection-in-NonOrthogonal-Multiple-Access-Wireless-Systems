...
% System parameters
lengthCP = 20; % length of cyclic prefix (for CP=20)
numPSC = 64; % number of pilot subcarriers (as in Fig. 3)
numUE = 2;
...
save('trainDataCP20.mat','XTrain','YTrain','h','numPSC','lengthCP','idx_sc','fixedPilot');